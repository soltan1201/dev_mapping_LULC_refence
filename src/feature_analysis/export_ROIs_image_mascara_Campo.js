// https://code.earthengine.google.com/5aeb5aaf2913191410ccda96886b0756
...
var name_export= 'poligons_area_campestre';
processoExportar(campestre, name_export, idAssetBase);
var imgFormCamp  = campestre_amostras.reduceToImage(['classe'], ee.Reducer.first())
Map.addLayer(imgFormCamp, {min:0, max: 1}, 'Formacao Campestre');
name_export= 'mascara_areas_campestre_image';
processoExportarImage(imgFormCamp, name_export, idAssetBase, regiaoCaat);
