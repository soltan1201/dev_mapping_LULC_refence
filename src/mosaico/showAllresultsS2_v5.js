...
// projects/mapbiomas-workspace/AMOSTRAS/col8/CAATINGA/mapas_referencias/mapa_SC-24-V-D_0_2020_GTB_v5_urbano
var classRFv2 = imgClass.filter(ee.Filter.eq('version', '2'))
...
var mascaraUrb = ee.Image(param['asset_geodatin_urbano']);
// mascaraUrb.unamsk
var mascaraAgro = ee.Image(param['asset_geodatin_agro']);
...
Map.addLayer(mascaraUrb, {min: 0, max: 1}, 'urbano', false);
Map.addLayer(mascaraAgro, {min: 0, max: 1}, 'Agrope', false);
Map.addLayer(classRFv2, vis.visclassCC, 'class RF_v2', false);
