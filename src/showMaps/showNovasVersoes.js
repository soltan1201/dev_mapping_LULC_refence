...
var mapRefeCartV0 = ee.ImageCollection(param.asset_maps_refV2);                       
print("Numero de imagens by subgrade ", mapRefeCartV0);
...
// mapa de referencia de toda a carta 
var mapRefeCartV9 = ee.ImageCollection(param.asset_maps_ref)
...
Map.addLayer(mapRefeCartV9, vis.visclassCC, 'class RF carta V9');
Map.addLayer(mapRefeCartV14, vis.visclassCC, 'class RF carta V0');
...
Map.addLayer(maskGedi.eq(0).focal_min(10).selfMask(), {min:0, max: 1, palette: 'FFC300'}, 'Gedi 0', false);
